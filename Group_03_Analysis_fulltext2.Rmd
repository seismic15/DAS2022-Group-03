...
$$
\log(\frac{p_i}{1-p_i}) = \alpha + \beta_1 \log(x_{1i}) +\beta_2 log(x_{2i}) +\beta_3 x_{3i} +  \beta_4 \mbox{I}(x_{4i}) + \beta_5 \mbox{I}(x_{5i}) + \beta_6 \mbox{I}(x_{6i}) + \epsilon_i,
$$
where 
...
$$
\log(\frac{p_i}{1-p_i}) = \alpha + \beta_1 \log(x_{1i}) +\beta_2 log(x_{2i}) +\beta_3 x_{3i} + \beta_4 \mbox{I}(x_{4i}) + \beta_5 \mbox{I}(x_{5i}) + \beta_6 \mbox{I}(x_{6i}) + \beta_7 \log(x_{7i}) + \beta_8 \log(x_{8i}) + \beta_9 x_{9i} + \epsilon_i,
$$
where 
